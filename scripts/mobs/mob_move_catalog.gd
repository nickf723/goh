...
const DEFINITIONS: Dictionary = {
	...
	"peck": {
		"id": "peck",
		"display_name": "Peck",
		"description": "A quick beak strike shared by birds and other beaked creatures.",
		"action_kind": "attack",
		"target_mode": "enemy",
		"tags": ["attack", "melee", "contact", "beak"],
		"required_body_tags": ["beak"],
		"minimum_range": 0.0,
		"maximum_range": 1.6,
		"cooldown": 0.75,
		"base_utility": 0.85,
		"timing": {
			...
			"active": 0.12,
			"recovery": 0.28,
			"interruptible_phases": ["startup", "recovery"],
		},
		"effect": {
			"kind": "damage",
			"damage": 2,
	...
	"climb": {
		"id": "climb",
		"display_name": "Climb",
		"description": "Traverse a compatible wall, tree, cliff, or ceiling while maintaining surface contact.",
		"action_kind": "movement",
		"target_mode": "environment",
		"tags": ["movement", "surface", "habitat", "climbing"],
		"required_locomotion_tags": ["climber"],
		"minimum_range": 0.0,
		"maximum_range": 12.0,
		"cooldown": 0.8,
		"base_utility": 0.9,
		"timing": {"startup": 0.05, "active": 1.9, "recovery": 0.2},
		"effect": {"kind": "move_to_tag", "target_tag": "climb_route", "speed_multiplier": 1.0},
		"augment_slots": ["instinct"],
	},
	"burrow": {
		"id": "burrow",
		"display_name": "Burrow",
		"description": "Follow an authored soil, sand, snow, or tunnel route beneath cover.",
		"action_kind": "movement",
		"target_mode": "environment",
		"tags": ["movement", "volumetric", "habitat", "burrowing"],
		"required_locomotion_tags": ["burrower"],
		"minimum_range": 0.0,
		"maximum_range": 12.0,
		"cooldown": 0.8,
		"base_utility": 0.9,
		"timing": {"startup": 0.08, "active": 1.9, "recovery": 0.22},
		"effect": {"kind": "move_to_tag", "target_tag": "burrow_route", "speed_multiplier": 0.9},
		"augment_slots": ["instinct"],
	},
	"wade": {
		"id": "wade",

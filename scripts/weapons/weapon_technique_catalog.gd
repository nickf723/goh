...
const DASH_DEFINITIONS: Dictionary = {
	...
	"lance": {"name": "Driving Thrust", "heavy_name": "Impaling Rush", "damage": 1.12, "stance": 1.12, "range": 0.65, "move": 1.15, "tag": "driving_thrust"},
	"axe": {"name": "Rushing Cleave", "heavy_name": "Sundering Rush", "damage": 1.12, "stance": 1.28, "range": 0.25, "move": 0.82, "tag": "rushing_cleave"},
	"bow": {"name": "Skirmish Shot", "heavy_name": "Driving Shot", "damage": 1.1, "stance": 1.0, "range": 0.5, "move": 0.75, "tag": "skirmish_shot"},
	"hammer": {"name": "Meteor Rush", "heavy_name": "Avalanche Rush", "damage": 1.08, "stance": 1.48, "range": 0.18, "move": 0.78, "tag": "meteor_rush"},
	"mace": {"name": "Shoulder Break", "heavy_name": "Ram Break", "damage": 1.1, "stance": 1.38, "range": 0.2, "move": 0.82, "tag": "shoulder_break"},
	"daggers": {"name": "Blinking Fang", "heavy_name": "Twin Fang Rush", "damage": 1.22, "stance": 0.9, "range": 0.18, "move": 1.12, "tag": "blinking_fang"},
	"whip": {"name": "Pursuit Crack", "heavy_name": "Pursuit Lash", "damage": 1.08, "stance": 1.15, "range": 0.7, "move": 0.72, "tag": "pursuit_crack"},
	"chains": {"name": "Comet Chain", "heavy_name": "Anchor Rush", "damage": 1.12, "stance": 1.3, "range": 0.45, "move": 0.84, "tag": "comet_chain"},
	"gauntlets": {"name": "Burst Knuckle", "heavy_name": "Breaker Knuckle", "damage": 1.18, "stance": 1.22, "range": 0.12, "move": 1.0, "tag": "burst_knuckle"},
	"flail": {"name": "Orbit Crash", "heavy_name": "Deadweight Rush", "damage": 1.14, "stance": 1.3, "range": 0.35, "move": 0.84, "tag": "orbit_crash"},
	"halberd": {"name": "Charging Reap", "heavy_name": "Hooking Charge", "damage": 1.12, "stance": 1.24, "range": 0.55, "move": 0.94, "tag": "charging_reap"},
	"boomerang": {"name": "Slipstream Cast", "heavy_name": "Crosswind Cast", "damage": 1.12, "stance": 1.0, "range": 0.48, "move": 0.88, "tag": "slipstream_cast"},
	"scythe": {"name": "Death's Passage", "heavy_name": "Grave Passage", "damage": 1.16, "stance": 1.18, "range": 0.48, "move": 0.9, "tag": "deaths_passage"},
	"staff": {"name": "Vaulting Sweep", "heavy_name": "Pillar Rush", "damage": 1.08, "stance": 1.3, "range": 0.35, "move": 0.95, "tag": "vaulting_sweep"},
	"shuriken": {"name": "Running Volley", "heavy_name": "Pinning Volley", "damage": 1.18, "stance": 0.9, "range": 0.42, "move": 1.0, "tag": "running_volley"},
}

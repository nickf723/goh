...
const GROUND_SPELL_DEFS: Dictionary = {
	...
	"wind_well": {
		"spell_key": "wind_well",
		"spell_ids": ["wind_well"],
		"display_names": ["wind well"],
		"element": "air",
		"effect_type": "spawn_field",
		"post_spawn_method": "begin_well",
		"begin_message": "Place Wind Well. Right stick moves the updraft. Cast confirms. Cancel backs out.",
		"cancel_message": "Wind Well canceled.",
		"confirm_message": "A rising current takes hold.",
		"target": {
			"marker_name": "WindWellTargetMarker",
			"disc_name": "WindWellLiftDisc",
			"center_name": "WindWellCenter",
			"shape": "circle",
			"placement": "free_ground",
			"radius": 2.8,
			"range": 13.0,
			...
			"deadzone": 0.18,
			"ground_y_offset": 0.05,
			"cast_lock_duration": 0.28,
			"require_ground": true,
			"require_line_of_sight": true,
			"allow_through_obstacles": false,
			"show_direction_line": false,
			"disc_color": Color(0.96, 0.44, 0.76, 0.28),
			"center_color": Color(0.76, 0.9, 1.0, 0.84),
			"disc_alpha": 0.28,
			"center_alpha": 0.84,
			"outline_alpha": 0.96,
			"pulse_speed": 5.2,
			...
			"preview_label": "WIND WELL • PERSISTENT LIFT",
		},
		"payload": {
			"source_name": "Wind Well",
			"hit_type": "updraft_field",
			"tags": ["wind_well", "ground_targeted", "field", "updraft", "lift", "traversal", "non_damage"],
		},
	},
}

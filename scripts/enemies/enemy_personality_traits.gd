...
const PROFILES: Dictionary = {
	"balanced": {
		...
		"threat_reaction_delay_multiplier": 1.0,
	...
	"cautious": {
		...
		"description": "Protects itself, avoids hostile zones early, and favors defensive disengagement over risky attacks.",
		...
		"threat_reaction_delay_multiplier": 0.8,
	...
	"bold": {
		"display_name": "Bold",
		"description": "Pushes pressure, accepts more risk, and strongly favors lunging attacks.",
		...
		"threat_reaction_delay_multiplier": 1.15,
		"post_miss_retreat_time": 0.0,
		"post_miss_retreat_speed_multiplier": 1.0,
	...
	"skittish": {
		...
		"description": "Keeps extra distance from danger, pounces from range, and strongly favors escape when crowded.",
		...
		"threat_reaction_delay_multiplier": 0.65,
	...
	"brute": {
		"display_name": "Brute",
		"description": "Ignores softer control, crowds its target, and favors close pressure over evasion.",
		...
		"threat_reaction_delay_multiplier": 1.6,
		"post_miss_retreat_time": 0.0,
	...
	"opportunist": {
		...
		"threat_reaction_delay_multiplier": 0.9,

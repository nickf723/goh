extends "res://scripts/alchemy/alchemy_cauldron.gd"
class_name AlchemyCauldronInsight

# Challenge-backed alchemy insight. The base cauldron owns brewing and
# inventory mutation; this layer adds a non-destructive preview after Kitchen
# Chemistry has been completed.

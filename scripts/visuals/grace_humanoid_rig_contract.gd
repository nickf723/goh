...
const SEMANTIC_ALIASES: Dictionary = {
	...
	"upper_arm_l": ["upper_arm_l", "LeftUpperArm", "UpperArm_L", "LeftArm"],
	"forearm_l": ["forearm_l", "LeftLowerArm", "ForeArm_L", "LeftForeArm"],
	"hand_l": ["hand_l", "LeftHand", "Hand_L"],
	"clavicle_r": ["clavicle_r", "RightShoulder", "Clavicle_R"],
	"upper_arm_r": ["upper_arm_r", "RightUpperArm", "UpperArm_R", "RightArm"],
	"forearm_r": ["forearm_r", "RightLowerArm", "ForeArm_R", "RightForeArm"],
	"hand_r": ["hand_r", "RightHand", "Hand_R"],
	"thigh_l": ["thigh_l", "LeftUpperLeg", "Thigh_L", "LeftUpLeg"],
	"shin_l": ["shin_l", "LeftLowerLeg", "Shin_L", "LeftLeg"],
	"foot_l": ["foot_l", "LeftFoot", "Foot_L"],
	"toe_l": ["toe_l", "LeftToes", "Toe_L", "LeftToeBase"],
	"thigh_r": ["thigh_r", "RightUpperLeg", "Thigh_R", "RightUpLeg"],
	"shin_r": ["shin_r", "RightLowerLeg", "Shin_R", "RightLeg"],
	"foot_r": ["foot_r", "RightFoot", "Foot_R"],
	"toe_r": ["toe_r", "RightToes", "Toe_R", "RightToeBase"],
}

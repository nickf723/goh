...
const PRESETS: Dictionary = {
	"light_tick": {
		"label": "Light Tick",
		"haptic": {"weak": 0.10, "strong": 0.00, "duration": 0.055, "device": 0},
		"tags": ["ui", "light"],
	},
	"pickup_collect": {
		"label": "Pickup Collect",
		"haptic": {"weak": 0.16, "strong": 0.08, "duration": 0.07, "device": 0},
		"tags": ["pickup", "resource", "collect"],
	},
	"full_charge": {
		"label": "Full Charge",
		"haptic": {"weak": 0.20, "strong": 0.65, "duration": 0.16, "device": 0},
		"tags": ["ability", "charge", "firebolt"],
	},
	"spell_prepare": {
		"label": "Spell Prepare",
		"haptic": {"weak": 0.08, "strong": 0.00, "duration": 0.05, "device": 0},
		"tags": ["presentation", "spell", "prepare"],
	},
	"spell_release": {
		"label": "Spell Release",
		"haptic": {"weak": 0.18, "strong": 0.12, "duration": 0.075, "device": 0},
		"tags": ["presentation", "spell", "release"],
	},
	"spell_manifest": {
		"label": "Spell Manifest",
		"haptic": {"weak": 0.20, "strong": 0.30, "duration": 0.105, "device": 0},
		"tags": ["presentation", "spell", "manifest", "summon"],
	},
	"spell_latch": {
		"label": "Spell Latch",
		"haptic": {"weak": 0.25, "strong": 0.12, "duration": 0.085, "device": 0},
		"tags": ["presentation", "spell", "latch", "tether"],
	},
	"spell_resolve": {
		"label": "Spell Resolve",
		"haptic": {"weak": 0.16, "strong": 0.22, "duration": 0.085, "device": 0},
		"tags": ["presentation", "spell", "resolve"],
	},
	"guard_block": {
		"label": "Guard Block",
		"haptic": {"weak": 0.45, "strong": 0.85, "duration": 0.13, "device": 0},
		"tags": ["defense", "guard", "impact"],
	},
	"hit_collision": {
		"label": "Hit Collision",
		"haptic": {"weak": 0.18, "strong": 0.22, "duration": 0.075, "device": 0},
		"tags": ["combat", "contact", "hit"],
	},
	"impact_light": {
		"label": "Light Impact",
		"haptic": {"weak": 0.08, "strong": 0.035, "duration": 0.045, "device": 0},
		"tags": ["presentation", "combat", "impact", "light"],
	},
	"impact_medium": {
		"label": "Medium Impact",
		"haptic": {"weak": 0.18, "strong": 0.20, "duration": 0.075, "device": 0},
		"tags": ["presentation", "combat", "impact", "medium"],
	},
	"impact_resist": {
		"label": "Resisted Impact",
		"haptic": {"weak": 0.07, "strong": 0.24, "duration": 0.06, "device": 0},
		"tags": ["presentation", "combat", "impact", "resist"],
	},
	"impact_stagger": {
		"label": "Stagger Impact",
		"haptic": {"weak": 0.26, "strong": 0.58, "duration": 0.115, "device": 0},
		"tags": ["presentation", "combat", "impact", "stagger"],
	},
	"impact_launch": {
		"label": "Launch Impact",
		"haptic": {"weak": 0.34, "strong": 0.78, "duration": 0.15, "device": 0},
		"tags": ["presentation", "combat", "impact", "launch"],
	},
	"impact_break": {
		"label": "Guard Break Impact",
		"haptic": {"weak": 0.36, "strong": 0.90, "duration": 0.17, "device": 0},
		"tags": ["presentation", "combat", "impact", "break"],
	},
	"break_heavy": {
		"label": "Object Break",
		"haptic": {"weak": 0.28, "strong": 0.68, "duration": 0.13, "device": 0},
		"tags": ["presentation", "break", "destruction"],
	},
	"landing_impact": {
		"label": "Landing Impact",
		"haptic": {"weak": 0.12, "strong": 0.24, "duration": 0.07, "device": 0},
		"tags": ["presentation", "movement", "landing"],
	},
	"player_hit": {
		"label": "Player Hit",
		"haptic": {"weak": 0.32, "strong": 0.55, "duration": 0.12, "device": 0},
		"tags": ["combat", "player", "damage"],
	},
	"heavy_impact": {
		"label": "Heavy Impact",
		"haptic": {"weak": 0.35, "strong": 1.00, "duration": 0.20, "device": 0},
		"tags": ["combat", "impact"],
	},
	"low_health_warning": {
		"label": "Low Health Warning",
		"haptic": {"weak": 0.22, "strong": 0.30, "duration": 0.10, "device": 0},
		"tags": ["health", "warning"],
	},
}
...
static func get_preset(feedback_id: String) -> Dictionary:
	...
	return {"label": feedback_id.capitalize(), "haptic": {}, "tags": ["unknown"]}


static func play_haptics(feedback_data: Dictionary) -> void:
	if not HAPTICS_ENABLED or not feedback_data.has("haptic"):
		return

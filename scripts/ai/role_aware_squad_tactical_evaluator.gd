...
static func evaluate(
	...
	var role_result: Dictionary = RoleCatalog.evaluate_candidate(
		role_id,
		candidate,
		result
	)
	...
	var role_reasons: Array[String] = _strings_preserve_case(
		role_result.get("reasons", [])
	)
	var role_penalties: Array[String] = _strings_preserve_case(
		role_result.get("penalties", [])
	)
	...
	var matched_traits: Array[String] = _strings_preserve_case(
		role_result.get("matched_traits", [])
	)

...
class_name Grace05BlockoutModelV3

# V3 removes BoneAttachment3D from the visible blockout completely. Every mesh
# is a direct child whose transform is rebuilt from a semantic skeleton bone each
# frame, matching the proven geometry-following pattern of the old full-height
# procedural proxy.
...
func _enter_tree() -> void:
	...
	set_meta("grace_0_5_blockout_v3", true)
...
func get_debug_data() -> Dictionary:
	...
	data["grace_0_5_blockout_v3"] = true

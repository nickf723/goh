extends "res://scripts/weather/thunderstorm_weather_controller.gd"
class_name ThunderstormWeatherControllerConcentrationBudget
...
func stop_weather(show_feedback: bool = true) -> void:
	...
	if show_feedback and show_messages:
		show_message("The thunderstorm releases its own reserved Mana and fades.")
